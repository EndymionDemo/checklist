...
exports.rgb = exports.rgba = exports.namedColor = exports.h2d = exports.parsing = exports.hexToRGB = exports.checkValueForColor = void 0;
function checkValueForColor(value) {
    if (value.includes('#')) {
    ...
    if ((0, exports.namedColor)().has(value.toUpperCase())) {
        var hex = (0, exports.namedColor)().get(value.toUpperCase());
...
exports.checkValueForColor = checkValueForColor;
